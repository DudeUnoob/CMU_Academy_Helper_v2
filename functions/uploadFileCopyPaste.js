...
async function uploadFileCopyPaste(req, res, next, authToken, username, fileTitle, codeScript){
    const payloadObj = {
        path: fileTitle,
        fileOwner: username,
        content: codeScript,
...
module.exports = uploadFileCopyPaste
